...
const TransactionHistory = ({ transactions, onRefresh, year }) => {
  ...
  const months = useMemo(() => {
    ...
    transactions.forEach((tx) => {
      ...
      const monthGroup = generatedMonths.find((m) =>
  ...
  const scroll = (direction) => {
    if (scrollRef.current) {
      const scrollAmount = 714; // Wider cards now
    ...
    <div className={styles.container}>
      ...
      <div className={styles.scrollArea} ref={scrollRef} onScroll={handleScrollEvent}>
        {months.map((month) => {
          ...
          const monthExpenseTotal = month.txs
          ...
          return (
            <div key={month.id} className={styles.monthCard}>
              ...
              <div className={styles.columns}>
                ...
                <div className={styles.column}>
                  ...
                  <div className={styles.list}>
                    ...
                    <button
                      className={styles.inlineAddBtn}
                      onClick={() => setIsAddingCat('expense')}
                    >
              ...
              <div className={styles.balance}>
                ...
                <div
                  className={
                    monthIncomeTotal - monthExpenseTotal > 0 ? styles.positive : styles.negative
                  }
                >
      ...
      <Modal
        isOpen={!!isAddingCat}
        onClose={() => setIsAddingCat(null)}
        title={`New ${isAddingCat === 'income' ? 'Income' : 'Expense'} Category`}
      >
        <form
