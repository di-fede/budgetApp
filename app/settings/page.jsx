...
export default function SettingsPage() {
  ...
  const handleDeleteCategory = (id) => {
    if (confirm('Delete this category? Transactions will remain but lose their category label visually.')) {
      deleteCategory(id);
      setCategories(getCategories());
    }
  };
        ...
        <form onSubmit={handleAddCategory} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
            ...
            <select 
              ...
              style={{ padding: '0.5rem', borderRadius: '6px', background: '#0d1117', color: 'white', border: '1px solid var(--card-border)' }}
            >
          ...
          <button type="submit" style={{ marginTop: '1rem', padding: '0.75rem', background: 'var(--primary)', color: 'white', borderRadius: '8px', fontWeight: 600 }}>
            Save Category
          </button>
        </form>
      </Modal>
