...
export const exportData = () => {
  ...
  const data = {
    ...
    categories: getFromStorage(STORAGE_KEYS.CATEGORIES, DEFAULT_CATEGORIES),
    recurring: getFromStorage(STORAGE_KEYS.RECURRING, []),
...
export const importData = (jsonData) => {
  ...
  try {
    ...
    if (!data.categories || !Array.isArray(data.categories)) throw new Error('Invalid categories');
